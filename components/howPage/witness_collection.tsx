...
import { WitnessInformation } from "../../logic/logic";
...
export const WitnessList = ({}: WitnessListProps) => {
    ...
    return (
        <div>
            <button type="button" onClick={() => setShowNewWitness(true)}>New Witness</button>
            {showNewWitness &&
            <div>
                <Inputfield
                labelText="Name"
                ...
                <button type="button" onClick={handleNewWitness}>Save</button>
            </div>
            }
            <ul>
